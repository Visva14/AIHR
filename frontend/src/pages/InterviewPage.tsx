    ...
    return (
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: '20px', fontWeight: 600, color: '#111', marginBottom: '8px' }}>Link unavailable</div>
          <div style={{ fontSize: '13.5px', color: '#888', lineHeight: 1.6 }}>{invalidMessage}</div>
        </div>
      </div>
    );
  }
          ...
          >
            ...
            >
              <svg width="14" height="14" viewBox="0 0 26 26" fill="none">
                ...
                <path d="M2 22c0-4.4 3.6-8 8-8s8 3.6 8 8" stroke="white" strokeWidth="2" strokeLinecap="round" />
                <circle cx="21" cy="8" r="1.8" fill="white" />
              </svg>
            </div>
            <span
              style={{
          ...
          >
              ...
              <>
                <StepIcon>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M4 6h16v12H4z" stroke="#555" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="m4.5 6.5 7.5 6 7.5-6" stroke="#555" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </StepIcon>
                <div style={{ fontSize: '20px', fontWeight: 600, color: '#111', marginBottom: '6px', lineHeight: 1.3 }}>
                  Verify your email
                </div>
                <div style={{ fontSize: '13.5px', color: '#888', lineHeight: 1.6, marginBottom: '22px' }}>
            ...
            {step === 1 && (
              <>
                <StepIcon>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M9 6V4.5A1.5 1.5 0 0 1 10.5 3h3A1.5 1.5 0 0 1 15 4.5V6" stroke="#555" strokeWidth="1.7" strokeLinecap="round" />
                    <path d="M4 7h16v11a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V7Z" stroke="#555" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </StepIcon>
                <div style={{ fontSize: '20px', fontWeight: 600, color: '#111', marginBottom: '6px', lineHeight: 1.3 }}>
                  Interview details
            ...
            {step === 2 && (
              <>
                <StepIcon>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    <path d="M12 3l7 4v5c0 4.8-2.9 7.7-7 9-4.1-1.3-7-4.2-7-9V7l7-4Z" stroke="#555" strokeWidth="1.7" strokeLinejoin="round" />
                    <path d="M9.5 12.5l1.7 1.7L14.8 10.6" stroke="#555" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </StepIcon>
                <div style={{ fontSize: '20px', fontWeight: 600, color: '#111', marginBottom: '6px', lineHeight: 1.3 }}>
              ...
              <>
                <StepIcon>
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                    ...
                    <path d="M12 10v5M12 7.5h.01" stroke="#555" strokeWidth="1.7" strokeLinecap="round" />
                  </svg>
                </StepIcon>
                <div style={{ fontSize: '20px', fontWeight: 600, color: '#111', marginBottom: '6px', lineHeight: 1.3 }}>
                  Before you start
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: '1220px', margin: '0 auto', width: '100%', flex: 1, display: 'flex', flexDirection: 'column', minHeight: 0 }}>
        ...
        >
          <div>
            <div style={{ fontSize: '12px', letterSpacing: '0.18em', color: '#999', textTransform: 'uppercase' }}>AIHR Interview Room</div>
            <div style={{ fontSize: '24px', fontWeight: 600, color: '#111', marginTop: '4px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', flexWrap: 'wrap' }}>
            <div
              style={{
                background: warningCount > 0 ? '#fef2f2' : '#f8f8f8',
                border: `1px solid ${warningCount > 0 ? '#fecaca' : 'rgba(0,0,0,0.08)'}`,
                borderRadius: '8px',
                padding: '6px 12px',
                fontSize: '12px',
                fontWeight: 500,
                color: warningCount > 0 ? '#b91c1c' : '#aaa',
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                borderRadius: '12px',
                border: 'none',
                background: answeredCount >= totalQuestions ? '#111' : '#ccc',
                color: '#fff',
                fontSize: '13px',
                fontWeight: 600,
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '14px' }}>
              <div>
                <div style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.12em', color: '#999' }}>Question</div>
                <div style={{ fontSize: '28px', fontWeight: 700, color: '#111', marginTop: '6px' }}>
          ...
          <section style={{ padding: '12px 16px 12px 0', display: 'flex', flexDirection: 'column', gap: '10px', overflow: 'hidden', minHeight: 0 }}>
              ...
              >
                <span
                  style={{
                    ...
                    height: '8px',
                    borderRadius: '50%',
                    background: isAnswering ? '#ef4444' : '#d1d5db',
            ...
            >
              <div style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.12em', color: '#999', marginBottom: '10px' }}>
                Audio Activity
              </div>
            ...
            >
              <div style={{ fontSize: '12px', textTransform: 'uppercase', letterSpacing: '0.12em', color: '#999', marginBottom: '10px', flexShrink: 0 }}>
                Live Caption
              </div>
              <div style={{ flexShrink: 0, maxHeight: '72px', overflow: 'hidden', fontSize: '13px', lineHeight: 1.6, color: '#444' }}>
...
function StepButton({
  ...
  return (
    <button
      ...
      onMouseOver={(e) => {
        if (!disabled) e.currentTarget.style.background = style?.background?.toString() === '#16a34a' ? '#15803d' : '#333';
      }}
      onMouseOut={(e) => {
        e.currentTarget.style.background = (style?.background as string) || '#111';
      }}
      onMouseDown={(e) => {
        e.currentTarget.style.transform = 'scale(0.98)';
      }}
...
function InfoRow({ label, value }: { label: string; value: string }) {
  return (
    ...
    >
      ...
      <span style={{ fontSize: '13px', fontWeight: 500, color: '#111', textAlign: 'right' }}>{value}</span>
    </div>
  );
}
...
function InstructionItem({
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: '13px', color: '#555', lineHeight: 1.6 }}>{children}</div>
    </div>
  );
}
    ...
    >
      <div
        style={{
          ...
          background: isWarning ? '#fef3c7' : '#111',
          color: isWarning ? '#92400e' : '#fff',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
          fontSize: '11px',
    ...
    >
      <div
        style={{
          ...
          boxShadow: active ? '0 0 0 3px rgba(17,17,17,0.06)' : 'none',
        }}
      >
        {completed ? (
      ...
      <div style={{ flex: 1 }}>
        <div style={{ fontSize: '13px', fontWeight: 600, color: waiting ? '#999' : '#111' }}>{label}</div>
        <div style={{ fontSize: '12px', color: waiting ? '#b0b0b0' : '#666', lineHeight: 1.5 }}>{description}</div>
      </div>
      {completed ? (
        <span
          style={{
