...
export default function CreateJD({ onBack, onSuccess }: CreateJDProps) {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setError(err?.response?.data?.detail || err?.message || 'Failed to create JD');
    } finally {
      setSaving(false);
    }
  }
