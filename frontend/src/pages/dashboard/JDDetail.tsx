    ...
    <div className="jdx-page">
      ...
      <section className="jdx-head-card">
        ...
        {hasCandidates && (
          <div className="jdx-actions">
            <button className="jdx-action-btn" disabled={screening} onClick={openUploadDialog} type="button">
              <UploadIcon />
              Add More Resumes
            </button>
            <button
      ...
      {!hasCandidates ? (
        <section className="jdx-empty-card">
          ...
          <div className="jdx-upload-zone" onClick={openUploadDialog} role="button" tabIndex={0}>
            <UploadCloudIcon className="jdx-upload-icon" />
            <div className="jdx-upload-title">Upload resumes to get started</div>
            <div className="jdx-upload-sub">Drop PDF or DOCX files here, or click to browse.</div>
            <button
          ...
          <div className="jdx-empty-note">Screening, shortlisting and interview tools will appear after resumes are uploaded.</div>
        </section>
      ) : (
